...
df1 = pd.read_excel(r"C:\Users\Administrator\Desktop\报告3\年度时序预测Trans.xlsx")
output_file = r'C:\Users\Administrator\Desktop\报告3\预测结果.txt'
with open(output_file, 'w') as f:
    for column in df1.columns[1:]:
        ...
        plt.savefig(f"C:\\Users\\Administrator\\Desktop\\报告3\\{column}_模型比较.png")
        plt.close()
